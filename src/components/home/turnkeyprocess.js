...
const TurnkeyProcess = () => {
    return (
        <section class="bg-sky-light pt-80 pb-80">
            <div class="container">
                <div class="our-turnkey-sec">
                    <h2 class="pb-46">Our Turnkey Process</h2>
                    <div class="row pb-46">
                        <div class="col-md-6">
                            <div class="our-turnkey-left">
                    ...
                    <div class="our-turnkey-listing">
                        <div class="row">
                            <div class="col-lg-3 col-md-6 turnkey-box-wrap">
                                <div class="our-turnkey-box">
                                    <div class="turnkey-box-img">
